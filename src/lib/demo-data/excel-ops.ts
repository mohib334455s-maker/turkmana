...
export const inventorySkus: Array<{ code: string; name: string; nameEn: string; unit: string; group: 'fuel' | 'food' | 'other' }> = [
  ...
  { code: 'OIL', name: 'روغن', nameEn: 'Edible oil', unit: 'کارتن', group: 'food' },
  { code: 'SUGAR', name: 'شکر', nameEn: 'Sugar', unit: 'خریطه', group: 'food' },
  { code: 'WHEAT', name: 'گندم', nameEn: 'Wheat', unit: 'تن', group: 'food' },
  { code: 'FLOUR', name: 'آرد', nameEn: 'Flour', unit: 'خریطه', group: 'food' },
  { code: 'RICE', name: 'برنج', nameEn: 'Rice', unit: 'خریطه', group: 'food' },
  { code: 'CORN', name: 'جواری', nameEn: 'Corn', unit: 'تن', group: 'food' },
  { code: 'TEA', name: 'چای', nameEn: 'Tea', unit: 'کارتن', group: 'food' },
